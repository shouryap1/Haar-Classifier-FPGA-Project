...
HD_PWD='C:/Users/Barath S Narayan/Vivado/FPGA_project_version3/FPGA_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multi_stage_classifier.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multi_stage_classifier.tcl -notrace
