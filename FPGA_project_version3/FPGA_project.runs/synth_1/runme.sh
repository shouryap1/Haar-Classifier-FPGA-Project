...
HD_PWD='C:/Users/Barath S Narayan/Vivado/FPGA_project_version3/FPGA_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multi_stage_classifier.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multi_stage_classifier.tcl
